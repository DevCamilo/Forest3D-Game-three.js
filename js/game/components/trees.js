(function()
{
    ...
    GAME.trees.addThin = function()
    {
        ...
        {
            var mesh = new THREE.Mesh(cylinderGeometry, GAME.DATA.treeBark2, 0);
    ...
    GAME.trees.addBirch = function()
    {
        ...
        {
            var mesh = new THREE.Mesh(cylinderGeometry, GAME.DATA.treeBark3, 0);
    ...
    GAME.trees.addSticks = function()
    {
        ...
        for (var i = 0; i < GAME.const.treeStickCount; i++)
        {
            ...
            var mesh = new THREE.Mesh(plane, material, 0);
    ...
    cap
		...
		*/
        ...
        for (var i = 0; i < num; i++)
        {
            ...
            var tree = new THREE.Mesh(geometry, mf, 0);
